...
export default function AdminDashboardPage() {
  ...
  const [heroTitle, setHeroTitle] = useState(
    'Edible Art, Deliciously Delivered.'
  );
  const [heroSubtitle, setHeroSubtitle] = useState(
    'Surprise your loved ones with our handcrafted snack bouquets.'
  );
  ...
  const filteredImages = placeholderImages.filter(
    (img) =>
                ...
                <Button
                  ...
                  onClick={() =>
                    toast({
                      ...
                      description:
                        'This is a mock upload. In production, this would upload to Firebase Storage.',
                    })
                  }
                >
                  Upload Image
                ...
                {filteredImages.map((img) => (
                  ...
                  >
                    ...
                    <div className="flex-grow space-y-2">
                      ...
                      <div className="space-y-1">
                        <Label htmlFor={`url-${img.id}`} className="text-xs">
                          Image URL
                        </Label>
                        <div className="flex gap-2">
                          ...
                          <Button
                            ...
                            className="h-8"
                            onClick={() =>
                              handleUpdateImage(img.id, 'new-url-here')
                            }
                          >
                            Update
                          </Button>
