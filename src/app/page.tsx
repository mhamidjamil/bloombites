...
export default function Home() {
  ...
  const customBuilderImage = placeholderImages.find(p => p.id === "custom-builder-promo");
        ...
        <div className="relative z-10 container mx-auto h-full flex flex-col justify-center px-4 md:px-6">
          <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-5 duration-1000">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <Button asChild size="lg" variant="outline" className="bg-transparent text-white border-white hover:bg-white/10 hover:text-white text-lg px-8 py-6 rounded-full shadow-lg backdrop-blur-sm">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-card border shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold font-headline mb-3">Fully Customizable</h3>
              <p className="text-muted-foreground">
                Create a unique gift by handpicking snacks, chocolates, and decorations to match their taste perfectly.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-card border shadow-sm hover:shadow-md transition-shadow">
              <div className="h-16 w-16 bg-primary/20 rounded-full flex items-center justify-center mb-6 text-primary">
              ...
              <h3 className="text-xl font-bold font-headline mb-3">Fast Delivery</h3>
              <p className="text-muted-foreground">
                We ensure your fresh and beautiful bouquet arrives on time to make their day special.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-card border shadow-sm hover:shadow-md transition-shadow">
              <div className="h-16 w-16 bg-primary/20 rounded-full flex items-center justify-center mb-6 text-primary">
              ...
              <h3 className="text-xl font-bold font-headline mb-3">Made with Love</h3>
              <p className="text-muted-foreground">
                Each arrangement is handcrafted by our skilled artisans with attention to detail and care.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center order-2 lg:order-1">
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Design a truly personal gift with our Custom Bouquet Builder. Choose from hundreds of premium snacks, chocolates, and unique add-ons. 
                  Whether it's for a birthday, anniversary, or just because - make it unique.
                </p>
                <div>
                  <Button asChild size="lg" className="bg-foreground text-background hover:bg-foreground/90 rounded-full px-8 py-6 text-lg">
